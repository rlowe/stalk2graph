...
thc<-(transaction_handlers_data$commit)
thr<-(transaction_handlers_data$rollback)
ths<-(transaction_handlers_data$savepoint)
thsr<-(transaction_handlers_data$savepoint_rollback)
