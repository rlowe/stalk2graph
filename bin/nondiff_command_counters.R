...
cs<-(command_counters_data$select)
cd<-(command_counters_data$delete)
ci<-(command_counters_data$insert)
cu<-(command_counters_data$update)
cr<-(command_counters_data$replace)
cl<-(command_counters_data$load)
cdm<-(command_counters_data$delete_multi)
cis<-(command_counters_data$insert_select)
cum<-(command_counters_data$update_multi)
crs<-(command_counters_data$replace_select)
