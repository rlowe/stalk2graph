...
sfj<-(select_types_data$full_join)
sfrj<-(select_types_data$full_range_join)
sr<-(select_types_data$range)
src<-(select_types_data$range_check)
ss<-(select_types_data$scan)
