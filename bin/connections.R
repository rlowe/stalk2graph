...
legend("bottom", ncol=3, legend=c("Max Connections", "Aborted Connets", "Aborted Clients", "Max Used Connections", "Threads Connected"), col=c("lightgray","red","green","yellow","blue"), lty=1,lwd=2, bty="n")
dev.off()
